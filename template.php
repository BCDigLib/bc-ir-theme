...
function bc_ir_theme_preprocess_html(&$variables) {
  drupal_add_css('https://fontlibrary.org/face/linear-regular', array('group' => CSS_THEME, 'preprocess' => TRUE));
  drupal_add_css('https://fontlibrary.org/face/open-baskerville', array('group' => CSS_THEME, 'preprocess' => TRUE));
  drupal_add_css('https://fontlibrary.org/face/news-cycle', array('group' => CSS_THEME, 'preprocess' => TRUE));
}
